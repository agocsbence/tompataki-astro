import { c as createComponent, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderScript, e as createAstro, r as renderComponent, f as renderSlot, p as renderHead } from './astro/server_C4GW52h0.mjs';
import 'piccolore';
/* empty css                         */
import 'clsx';
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- <div class="preloader-wrapper">
        <div class="preloader">
            <img src={loadIcon.src} alt="loading...">
        </div>
    </div> -->${maybeRenderHead()}<section id="header" data-astro-cid-3ef6ksr2> <div id="headline" data-astro-cid-3ef6ksr2> <a href="/" data-astro-cid-3ef6ksr2> <img${addAttribute(logoBlack.src, "src")} alt="Tom Pataki logo" data-astro-cid-3ef6ksr2> </a> <span data-astro-cid-3ef6ksr2>EN | HU</span> </div> <div id="navbar" data-astro-cid-3ef6ksr2> <div id="navbar-wrapper" data-astro-cid-3ef6ksr2> <div class="menu-main-menu-container" data-astro-cid-3ef6ksr2> <ul id="menu-main-menu" class="menu" data-astro-cid-3ef6ksr2> <li id="menu-item-265" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-265" data-astro-cid-3ef6ksr2><a href="/feature-films" data-astro-cid-3ef6ksr2>Feature films / Series</a></li> <li id="menu-item-64" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-64" data-astro-cid-3ef6ksr2><a href="/commercials" data-astro-cid-3ef6ksr2>Commercials</a></li> <li id="menu-item-63" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-63" data-astro-cid-3ef6ksr2><a href="/special-projects" data-astro-cid-3ef6ksr2>Special projects</a></li> <li id="menu-item-62" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-62" data-astro-cid-3ef6ksr2><a href="/showreel" data-astro-cid-3ef6ksr2>Showreel</a></li> <li id="menu-item-61" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-61" data-astro-cid-3ef6ksr2><a href="/about" data-astro-cid-3ef6ksr2>About</a></li> <li id="menu-item-60" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-60" data-astro-cid-3ef6ksr2><a href="/contact" data-astro-cid-3ef6ksr2>Contact</a></li> </ul> </div> <img${addAttribute(searchIcon.src, "src")} alt="Search" id="searchButton" data-astro-cid-3ef6ksr2> </div> </div> </section> <div id="search-overlay" data-astro-cid-3ef6ksr2> <div id="search-overlay-wrapper" data-astro-cid-3ef6ksr2> <span id="searchClose" data-astro-cid-3ef6ksr2>X</span> <form role="search" method="get" id="searchform" action="/search" data-astro-cid-3ef6ksr2> <div data-astro-cid-3ef6ksr2> <label for="q" data-astro-cid-3ef6ksr2>Search anything and hit enter</label> <input type="text" value="" name="q" id="q" placeholder="Search" data-astro-cid-3ef6ksr2> <input type="submit" id="searchsubmit" value="Search" class="button" data-astro-cid-3ef6ksr2> </div> </form> </div> </div> <section id="mobile-header" data-astro-cid-3ef6ksr2> <div id="logo" data-astro-cid-3ef6ksr2> <a href="/" data-astro-cid-3ef6ksr2> <img${addAttribute(logoBlack.src, "src")} alt="Tom Pataki logo" data-astro-cid-3ef6ksr2> </a> </div> <div id="menu" data-astro-cid-3ef6ksr2> <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="mobileMenu()" data-astro-cid-3ef6ksr2>&#9776;</a> </div> <div id="mobile-navbar" class="mobile-nav" data-astro-cid-3ef6ksr2> <div class="menu-main-menu-container" data-astro-cid-3ef6ksr2> <ul id="menu-main-menu-1" class="menu" data-astro-cid-3ef6ksr2> <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-265" data-astro-cid-3ef6ksr2><a href="/feature-films" data-astro-cid-3ef6ksr2>Feature films / Series</a></li> <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-64" data-astro-cid-3ef6ksr2><a href="/commercials" data-astro-cid-3ef6ksr2>Commercials</a></li> <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-63" data-astro-cid-3ef6ksr2><a href="/special-projects" data-astro-cid-3ef6ksr2>Special projects</a></li> <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-62" data-astro-cid-3ef6ksr2><a href="/showreel" data-astro-cid-3ef6ksr2>Showreel</a></li> <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-61" data-astro-cid-3ef6ksr2><a href="/about" data-astro-cid-3ef6ksr2>About</a></li> <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-60" data-astro-cid-3ef6ksr2><a href="/contact" data-astro-cid-3ef6ksr2>Contact</a></li> </ul> </div> </div> </section> ${renderScript($$result, "/Users/benceagocs/Documents/work/tompataki-astro/src/components/Header.astro?astro&type=script&index=0&lang.ts")} `;
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section id="footer"> <span class="copyright">©Tom Pataki All rights reserved.</span> <span class="policy">ALL IMAGES AND VIDEOS ARE COPYRIGHT OF THEIR RESPECTIVE OWNERS.</span> <span class="social"> <ul> <li> <a href="https://vimeo.com/user11416108" target="blank"> <img${addAttribute(vimeoIcon.src, "src")} alt="Tom Pataki Vimeo"> </a> </li> <li> <a href="https://www.instagram.com/tompataki/" target="blank"> <img${addAttribute(instagramIcon.src, "src")} alt="Tom Pataki Instagram"> </a> </li> </ul> </span> </section>`;
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet"><script src="//cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"><\/script><script src="//cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/jquery.magnific-popup.min.js"><\/script><script>\n			function mobileMenu() {\n				var x = document.getElementById("mobile-navbar");\n				if (x.className === "mobile-nav") {\n					x.className += " show";\n				} else {\n					x.className = "mobile-nav";\n				}\n			}\n		<\/script><meta name="generator"', '><meta name="description"', "><title>Tom Pataki</title>", "</head> <body", "> ", ' <section id="main-content"> ', " </section> ", `  <script>
	...
	if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
		$('.grid-details h2').each(function (index, element) {
		    var href = $(element).find('a').attr('href');
		    $(element).magnificPopup({
		        items: {
		            src: href
		...
		$('.featured-film-info .play').each(function (index, element) {
		    var href = $(element).find('a').attr('href');
		    $(element).magnificPopup({
		        items: {
		            src: href
	...
	$('#search-overlay span').on('click', function(){
	...
	if( $('body').hasClass('search-no-results') ) {
		$('#searchform').append('<h3 class="no-results">No results</h3>');
		$('#search-overlay-wrapper span').on('click', function() {
			window.location.replace('http://tompataki.com');
		})
	}
